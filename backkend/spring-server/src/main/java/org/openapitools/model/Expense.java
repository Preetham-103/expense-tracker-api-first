...
public class Expense {
  ...
  public Expense id(@Nullable Integer id) {
    this.id = id;
    return this;
  }
  ...
  public Expense title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  @Schema(name = "title", example = "Grocery shopping", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("title")
  ...
  public Expense amount(@Nullable Double amount) {
    this.amount = amount;
    return this;
  }
  ...
  @Schema(name = "amount", example = "120.5", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("amount")
  ...
  public Expense category(@Nullable String category) {
  ...
  public Expense date(@Nullable LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   */
  @Valid 
  @Schema(name = "date", example = "2025-08-31", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("date")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, expense.id) &&
        Objects.equals(this.title, expense.title) &&
